...
interface PureeLogStore {
     ...
     *
     * @param outputId The id of the [com.cookpad.puree.kmp.output.PureeBufferedOutput] that owns this log.
     ...
     *
     * @param outputId The id of the [com.cookpad.puree.kmp.output.PureeBufferedOutput] that owns the logs.
