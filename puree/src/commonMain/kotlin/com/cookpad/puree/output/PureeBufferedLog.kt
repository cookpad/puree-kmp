 ...
 * [com.cookpad.puree.store.PureeLogStore] before being sent to its final destination.
 * It is used by [com.cookpad.puree.output.PureeBufferedOutput] to implement the buffering
